...
assay(campp2_brca_se_1_NAs, withDimnames=FALSE)<-apply(assay(campp2_brca_se_1_NA), 2, function(x) {x[sample( c(1:n), floor(n/10))] <- NA; x})
...
campp2_brca_1_replacedNAs<-ReplaceNAs(SE=campp2_brca_se_1_NA, pct.NA.row=70, pct.NA.column=80) 
```
